...
\block{Inference Results}{
    ...
    \begin{tikzfigure}[Gaussian (50 runs)]
    ...
    \end{tikzfigure}
    \begin{tikzfigure}[SDT (100 runs)]
        \includegraphics[width=0.1\textwidth]{./figs/SDT/density_epsilon.pdf}
        \includegraphics[width=0.1\textwidth]{./figs/SDT/density_tree_depth.pdf}
        \raisebox{\height}{\scalebox{0.9}{
            \begin{tabular}{llll}
                \multirow{2}{*}{Sampler} & \multirow{2}{*}{$N$} & \multicolumn{2}{c}{ESS} \\
                & & $d$ & $c$ \\
    ...
    \end{tikzfigure}
    \begin{tikzfigure}[LR (50 runs)]
        \includegraphics[width=0.1\textwidth]{./figs/Linear_Regression/density_epsilon.pdf}
        \includegraphics[width=0.1\textwidth]{./figs/Linear_Regression/density_tree_depth.pdf}
