...
\block{Hamiltonian Monte Carlo Components}{
    Hamiltonian Monte Carlo (HMC) simulates Hamitonian dynamics to propose samples for a Markov chain (\cite{neal2011mcmc}).
...
\block{Hamiltonian Trajectory}{
    To compare the Hamiltonian trajectories between AHMC and Stan,
    ...
    \begin{tikzfigure}[LBA (50 runs); left to right: step size, tree depth, ESS (of some variables)]
        ...
        \raisebox{\height}{\scalebox{0.75}{
            \begin{tabular}{llllll}
                ...
                & & $\tau$ & $A$ & $k$ & $\nu_1$ \\
                \hline \\
                Stan & 10 & 112.94 & 224.35 & 115.161 & 202.87 \\
                AHMC & 10 & 373.606 & 332.105 & 307.505 & 385.342 \\
                Stan & 50 & 140.416 & 178.909 & 138.096 & 184.436 \\
                AHMC & 50 & 274.85 & 255.359 & 250.565 & 270.766 \\
                Stan & 200 & 151.011 & 173.519 & 146.133 & 241.527 \\
                AHMC & 200 & 273.304 & 269.158 & 257.299 & 289.361 \\
            \end{tabular}
        }}
    \end{tikzfigure}
}
...
% ├─────┼─────────────┼───────┼───────────┤
% │ 1   │ CmdStanNUTS │ 10    │ 0.811787  │
% │ 2   │ AHMCNUTS    │ 10    │ 0.338339  │
% │ 3   │ CmdStanNUTS │ 100   │ 0.774975  │
% │ 4   │ AHMCNUTS    │ 100   │ 0.36424   │
% │ 5   │ CmdStanNUTS │ 1000  │ 0.79924   │
% │ 6   │ AHMCNUTS    │ 1000  │ 0.80259   │
% SDT
% │ Row │ sampler     │ Nd    │ time_mean │
% │     │ String      │ Int64 │ Float64   │
% ├─────┼─────────────┼───────┼───────────┤
% │ 1   │ CmdStanNUTS │ 10    │ 0.775959  │
% │ 2   │ AHMCNUTS    │ 10    │ 0.328538  │
% │ 3   │ CmdStanNUTS │ 100   │ 0.726106  │
% │ 4   │ AHMCNUTS    │ 100   │ 0.320111  │
% │ 5   │ CmdStanNUTS │ 1000  │ 0.708934  │
% │ 6   │ AHMCNUTS    │ 1000  │ 0.317854  │
% LR
% │ Row │ sampler     │ Nd    │ time_mean │
% │     │ String      │ Int64 │ Float64   │
% ├─────┼─────────────┼───────┼───────────┤
% │ 1   │ CmdStanNUTS │ 10    │ 0.877141  │
% │ 2   │ AHMCNUTS    │ 10    │ 2.70077   │
% │ 3   │ CmdStanNUTS │ 100   │ 0.97563   │
% │ 4   │ AHMCNUTS    │ 100   │ 5.06673   │
% │ 5   │ CmdStanNUTS │ 1000  │ 2.31785   │
% │ 6   │ AHMCNUTS    │ 1000  │ 33.1288   │
% HPR
% │ Row │ sampler     │ Nd    │ time_mean │
% │     │ String      │ Int64 │ Float64   │
% ├─────┼─────────────┼───────┼───────────┤
% │ 1   │ CmdStanNUTS │ 1     │ 2.487     │
% │ 2   │ AHMCNUTS    │ 1     │ 19.4587   │
% │ 3   │ CmdStanNUTS │ 2     │ 3.50248   │
% │ 4   │ AHMCNUTS    │ 2     │ 28.2982   │
% │ 5   │ CmdStanNUTS │ 5     │ 5.89541   │
% │ 6   │ AHMCNUTS    │ 5     │ 40.0322   │
% LBA
% │ Row │ sampler     │ Nd    │ time_mean │
% │     │ String      │ Int64 │ Float64   │
% ├─────┼─────────────┼───────┼───────────┤
% │ 1   │ CmdStanNUTS │ 10    │ 2.57885   │
% │ 2   │ AHMCNUTS    │ 10    │ 2.62737   │
% │ 3   │ CmdStanNUTS │ 50    │ 12.2249   │
% │ 4   │ AHMCNUTS    │ 50    │ 10.7825   │
% │ 5   │ CmdStanNUTS │ 200   │ 41.3488   │
% │ 6   │ AHMCNUTS    │ 200   │ 55.592    │
\begin{tikztable}[Time comparisons between Stan and AdvancedHMC.jl for five models]
Below are time used to simulate the Hamiltonian trajectories,
measured in seconds.
\begin{tabular}{l|ll|ll|ll|ll|ll}
    ...
    % \hline \\
    Stan & 10 & 0.803881 & 10 & 0.775959 & 10 & 0.866924 & 10 & 2.487 & 10 & 2.57885  \\
    AHMC & 10 & 0.336073 & 10 & 0.328538 & 10 & 1.13563 & 10 & 19.4587 & 10 & 2.62737 \\
    Stan & 100 & 0.756092 & 100 & 0.726106 & 100 & 0.982419 & 20 & 3.50248 & 50 & 12.2249 \\
    AHMC & 100 & 0.33034 & 100 & 0.320111 & 100 & 1.32024 & 20 & 28.2982 & 50 & 10.7825 \\
    Stan & 1000 & 0.761393 & 1000 & 0.708934 & 1000 & 2.26 & 50 & 5.89541 & 200 & 41.3488 \\
    AHMC & 1000 & 0.508123 & 1000 & 0.317854 & 1000 & 3.83261 & 50 & 40.0322 & 200 & 55.592 \\
\end{tabular}
\end{tikztable}
}

\block{Remarks}{
    \paragraph{Turing.jl}, a probabilistic programming language in Julia, is used as the front-end to run AdvancedHMC.jl.
    Below is an example of running NUTS on the LR model using Turing.
    \lstinputlisting{lr.jl}
    \paragraph{Bijectors.jl} is used inside Turing.jl to do automatic transformation of constrained variables in order to run HMC.
    E.g. a random variable from $\mathcal{T}runcated(\mathcal{C}auchy(0, 5), 0, \infty)$ is constrained to be positive and will be transformed to the real space by the $\log$ function.
    \paragraph{CuArrays.jl} could be used with AdvancedHMC.jl to run NUTS on GPUs.
    In order to run NUTS using CUDA, one only needs to change Line 3 of the demo code from \texttt{q\_init = randn(D)} to \texttt{q\_init = CuArray(randn(D))}, assuming \texttt{logdensity\_f} and \texttt{grad\_f} in Line 6 are GPU friendly.
